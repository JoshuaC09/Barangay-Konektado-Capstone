		...
		<div class="sticky-header navbar-expand-lg">
            <div class="menu-bar clearfix">
                <div class="container clearfix">
					<div class="menu-logo">
						<a href="index"><img src="assets/images/logo_blackBG.png" alt=""></a>
					</div>
			...
			<div id="rev_slider_486_1_wrapper" class="rev_slider_wrapper fullwidthbanner-container" data-alias="news-gallery36" data-source="gallery" style="margin:0px auto;background-color:#ffffff;padding:0px;margin-top:0px;margin-bottom:0px;">
				<div id="rev_slider_486_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.3.0.2">
					<ul>	<!-- SLIDE  -->
						...
						data-description="Science says that Women are generally happier">
							...
							<div class="mainText tp-caption Newspaper-Title   tp-resizeme" 
								...
								style="z-index: 6; font-family:rubik; font-weight:700; text-align:center; white-space: normal;">
									BARANGAY <span style="color: #A2A2A2;">SAN VICENTE</span>
							</div>
						...
						data-easeout="default" 
						data-masterspeed="default" 
						data-thumb="assets/images/slider/slide2.jpg" 
						data-rotate="0" 
						data-fstransition="fade" 
						data-fsmasterspeed="1500" 
						data-fsslotamount="7" 
						...
						data-description="Science says that Women are generally happier">
							...
							<div class="tp-caption Newspaper-Subtitle   tp-resizeme" 
								...
								style="z-index: 7; white-space: nowrap;text-transform:uppercase; color:#fff; font-family:rubik; font-size:18px; font-weight:400;">
									<span style="font-size: 23px;">SANTA MARIA, BULACAN</span> 
							</div>
                ...
                <div class="container">
					<div class="row">
						<div class="col-lg-4 col-md-4 col-sm-12">
							<div class="service-bx">
								<div class="action-box">
									<img src="assets/images/our-services/services.png" alt="">
								</div>
						...
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="service-bx">
								<div class="action-box">
									<img src="assets/images/our-services/services2.png" alt="">
								</div>
								<div class="info-bx text-center">
									<div class="feature-box-sm radius bg-white">
						...
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="service-bx m-b0">
								<div class="action-box">
									<img src="assets/images/our-services/services1.png" alt="">
								</div>
								<div class="info-bx text-center">
									<div class="feature-box-sm radius bg-white">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12 heading-bx left">
							...
							<p>Officials of Barangay San Vicente</p>
						</div>
					</div>	
					 <div class="row">
                ...
                <div class="container">
					<div class="row">
						<div class="heading-bx left">
							...
							<p>Barangay San Vicente can generate brgy id, brgy. clearance, certificate of indigency and certificate of residency.</p>
						</div>
					</div>	
									...
									<div class="pricingtable-inner">
										<div class="pricingtable-main"> 
											...
											<div class="pricingtable-title">
												...
												<p>Barangay San Vicente</p>
											</div>
										</div>
										<ul style="height: 400px;" class="pricingtable-features">
