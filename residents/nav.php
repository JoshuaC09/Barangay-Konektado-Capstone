				...
				<nav class="ttr-sidebar-navi">
					<ul>
						...
						<li>
							<a href="feedback" class="ttr-material-button <?php echo ($page == 'feedback') ? "show2" : ""; ?>">
								<span class="ttr-icon"><i class="ti-files <?php echo ($page == 'feedback') ? "show2" : ""; ?>"></i></span>
								<span class="ttr-label <?php echo ($page == 'feedback') ? "show2" : ""; ?>">Feedback/Survey</span>
							</a>
						</li>
						
						<li>
							<a href="uploaddoc" class="ttr-material-button <?php echo ($page == 'uploaddoc') ? "show2" : ""; ?>">
								<span class="ttr-icon"><i class="ti-files <?php echo ($page == 'uploaddoc') ? "show2" : ""; ?>"></i></span>
								<span class="ttr-label <?php echo ($page == 'uploaddoc') ? "show2" : ""; ?>">Upload Supporting Docs</span>
							</a>
						</li>
