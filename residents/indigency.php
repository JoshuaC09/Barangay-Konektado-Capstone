	...
	<body class="ttr-opened-sidebar ttr-pinned-sidebar" style="background-color: #F3F3F3;">
							...
							<table id="table" class="table hover" style="width:100%">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<center>
													<a href="https://pm.link/orgbarangay-konektado01/test/DLSoA77" target="_blank"><button class="btn btn-block green radius-xl" style="float: right;">Pay Now</button>
											</center>
										</td>
									</tr>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">1st Select Request Document for Barangay Indigency<br>
