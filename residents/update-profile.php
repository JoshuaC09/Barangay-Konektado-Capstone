							...
							<div class="col-lg-12 m-b30">
												...
												<div class="form-group row">
													...
													<div class="col-sm-7">
														<select class="form-control" name="resident-status" required>
															<option value="Yes" <?php if ($r_resident_status == 'Yes') { echo 'selected'; } ?>>Yes</option>
															<option value="No" <?php if ($r_resident_status == 'No') { echo 'selected'; } ?>>No</option>
														</select>
													</div>
												</div>
												...
												<div class="form-group row">
													...
													<div class="col-sm-7">
														<select class="form-control" name="fourps" required>
															<option value="Yes" <?php if ($r_fourps == 'Yes') { echo 'selected'; } ?>>Yes</option>
															<option value="No" <?php if ($r_fourps == 'No') { echo 'selected'; } ?>>No</option>
														</select>
													</div>
												</div>
												<div class="form-group row">
										...
										<?php
											...
											if (isset($_POST['save_pass'])) {
												$model->verifyResident($r_id_number, $r_ext, $_POST['purok'], $_POST['birth-place'], $_POST['occupation'], $_POST['lot'], $r_fname, $r_mname, $r_lname, $_POST['gender'], $_POST['civil_status'], $_POST['block'], $_POST['email'], $r_password, $_POST['contact-number'], $_POST['birth-date'],$_POST['resident-since'], $_POST['resident-status'], $_POST['fourps'], $_SESSION['sess2']);
