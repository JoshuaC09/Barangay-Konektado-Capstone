...
<html lang="en">
	...
	<body class="ttr-opened-sidebar ttr-pinned-sidebar" style="background-color: #F3F3F3;">
							...
							<table id="table" class="table hover" style="width:100%">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<center>
													<a href="https://pm.link/orgbarangay-konektado01/test/szmvRE7" target="_blank"><button class="btn btn-block green radius-xl" style="float: right;">Pay Now</button>
											</center>
										</td>
									</tr>
		...
		<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2"
        aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel2">Welcome to the Request Services</h5>
                </div>
                <div class="modal-body">1st Select Request Document for Barangay Residency<br>
				2nd Input purpose details<br>
				Then Submit Request
				After that pay online or pay after processing your document
				</div>
                <div class="modal-footer">
