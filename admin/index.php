	...
	<body class="ttr-opened-sidebar ttr-pinned-sidebar"  style="background-color: #FCFCFC!important;">
		...
		<main class="ttr-wrapper" style="background-color: #FCFCFC;">
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-3">
						<a href="#"><div class="widget-card widget-bg3" style="background-image: linear-gradient(to right, #13bed4, #00c5dc, #00c5dc, #95dde6);">		
							<div class="icon">
								<i class="ti-user"></i>
							</div>				 
							<div class="wc-item">
								...
								<span class="wc-stats">
									<span class="counter">
										...
										<?php $ret=mysqli_query($con,"SELECT count(*) as tot_male FROM residents WHERE gender = 'Male'");
					...
					<div class="col-md-3">
						<a href="#"><div class="widget-card widget-bg2" style="background-image: linear-gradient(to right, #f52a4c, #f0526d, #f0526d, #f5677f);">	
							<div class="icon">
								<i class="ti-user"></i>
							</div>				 
							<div class="wc-item">
								...
								<span class="wc-stats">
									<span class="counter">
										<?php $ret=mysqli_query($con,"SELECT count(*) as tot_female FROM residents WHERE gender = 'Female'");
												while($row=mysqli_fetch_array($ret))
													{
														echo $row['tot_female'];
													}
					...
					<div class="col-md-3">
						<a href="#"><div class="widget-card widget-bg4" style="background-image: linear-gradient(to right, #16b595, #34bfa3, #4dc9b0, #63d4bd);">	
							<div class="icon">
								<i class="ti-user"></i>
							</div>				 
							<div class="wc-item">
								...
								<span class="wc-stats">
									<span class="counter">
										<?php $ret=mysqli_query($con,"SELECT count(*) as tot_fourps FROM residents WHERE fourps = 'Yes'");
												while($row=mysqli_fetch_array($ret))
													{
														echo $row['tot_fourps'];
													}
					...
					<div class="col-md-3">
						<a href="#"><div class="widget-card widget-bg2" style="background-image: linear-gradient(to right, #ffb822, #fac34d, #fcd174, #fad88e);">
							<div class="icon">
								<i class="ti-user"></i>
							</div>				 
							<div class="wc-item">
								...
								<span class="wc-stats">
									<span class="counter">
										<?php $ret=mysqli_query($con,"SELECT count(*) as tot_voter FROM residents WHERE resident_status = 'Yes'");
												while($row=mysqli_fetch_array($ret))
													{
														echo $row['tot_voter'];
													}
