				...
				<nav class="ttr-sidebar-navi">
					<ul>
						...
						<li>
							<a href="mailinbox" class="ttr-material-button <?php echo ($page == 'mailinbox') ? "show2" : ""; ?>">
								<span class="ttr-icon"><i class="ti-harddrives <?php echo ($page == 'mailinbox') ? "show2" : ""; ?>"></i></span>
								<span class="ttr-label <?php echo ($page == 'mailinbox') ? "show2" : ""; ?>">Mail Inbox</span>
							</a>
						</li>
