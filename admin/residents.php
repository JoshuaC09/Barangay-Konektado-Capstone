<?php
	...
	if(isset($_POST["export-pdf"])) { 
		...
		$obj_pdf->SetTitle("BRGY. SAN VICENTE - RESIDENTS");   
		...
		$content .= '
		<div align="center">
			<h2 style="color: black;">BARANGAY SAN VICENTE RESIDENTS</h2>
		</div>
					...
					<div class="col-lg-12 m-b30">
									...
									<table id="table" class="table hover" style="width:100%">
										...
										<tbody>
											...
											<tr>
												...
												<center>
												<span class="badge badge-<?php echo $verified2; ?>">
												<a href="" style="font-size: 14px;color: white;" data-toggle="modal" data-target="#status-<?php echo $row['id']; ?>"><?php echo $verified; ?></a></span>
												</center> 
												</td>
												<td>
												<center>
													&nbsp;<a href="idcardgenerated?id=<?php echo $id; ?>" class="btn blue" style="width: 50px; height: 37px;">
													<div data-toggle="tooltip" title="Print"><i class="ti-agenda" style="font-size: 12px;"></i></div></a>
													&nbsp;<a href="residents-profile?id=<?php echo $id; ?>" class="btn blue" style="width: 50px; height: 37px;">
													<div data-toggle="tooltip" title="Profile"><i class="ti-search" style="font-size: 12px;"></i></div></a>
													&nbsp;<a href="" class="btn red" style="width: 50px; height: 37px;" data-toggle="modal" data-target="#archive-<?php echo $id; ?>">
													<div data-toggle="tooltip" title="Archive"><i class="ti-archive" style="font-size: 12px;"></i></div></a>
												</center>
											</tr>
											...
											<div class="modal-content">
												...
												<div class="modal-body">
													<div class="row">
														...
														<div class="form-group col-3">
															<label class="col-form-label"><b>4'ps Status</b></label>
								...
								<?php
									...
									if (isset($_POST['add_resident'])) {
										...
										$sqlc = "SELECT email FROM `residents` WHERE email='$email'";
										$res1=mysqli_query($con,$sqlc);
										if (mysqli_num_rows($res1) > 0) {
											$row1 = mysqli_fetch_assoc($res1);
											if($email==isset($row1['email']))
											{
												echo "<script>alert('Email Already Exists!');window.open('residents', '_self')</script>";
											}
										}
										else{
											if ($email == "") {

												$result = $model->addResident($r_id, $ext, $address3, $bplace, $occupation, $fname, $mname, $lname, $bdate, $gender, $civil_status, $address1, $address2, $res_since, $date, $resident_status, $contact,$fourps);
												...
												$result = $model->addResident2($r_id, $ext, $address3, $bplace, $occupation, $fname, $mname, $lname, $bdate, $gender, $civil_status, $address1, $address2, $res_since, $date, $resident_status, $contact, $email, $digits_hash,$fourps);
												...
												$mail->isHTML(true);
												$mail->Subject = 'Welcome to Barangay San Vicente, Sta Maria, Bulacan 1st Portal - Account Verification';
