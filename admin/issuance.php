			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12 m-b30">
								...
								?>
								<div align="right">
									<!-- <a href="" class="btn green radius-xl" style="background-color: <?php echo $primary_color; ?>;" data-toggle="modal" data-target="#add-announcement"><i class="ti-book"></i><span>&nbsp;ADD NEW ISSUANCE</span></a>&nbsp;&nbsp; -->
									<!-- <a href="archived-issuance" class="btn red radius-xl"><i class="ti-archive"></i><span>&nbsp;ARCHIVED ISSUANCE</span></a> -->
								</div>
