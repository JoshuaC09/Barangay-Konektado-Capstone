<?php
	...
	if (!empty($department)) {
		foreach ($department as $dep) {
			...
			$resident_status = $dep['resident_status'];
			$fourps = $dep['fourps'];
							...
							<div class="col-lg-12 m-b30">
										...
										<form class="edit-profile" method="POST">
											<div class="">
												...
												<div class="form-group row">
													...
													<div class="col-sm-7">
														<input class="form-control" type="text" name="block" value="<?php echo $r_address; ?>">
													</div>
												</div>
												<div class="form-group row">
													<label class="col-sm-2 col-form-label">Lot</label>
													<div class="col-sm-7">
														<input class="form-control" type="text" name="lot" value="<?php echo $r_address2; ?>">
													</div>
												</div>
												<div class="form-group row">
												...
												<div class="form-group row">
													...
													<div class="col-sm-7">
														<select class="form-control" name="resident-status" required>
															<option value="Yes" <?php if ($resident_status == 'Yes') { echo 'selected'; } ?>>Yes</option>
															<option value="No" <?php if ($resident_status == 'No') { echo 'selected'; } ?>>No</option>
														</select>
													</div>
												</div>
												<div class="form-group row">
													<label class="col-sm-2 col-form-label">4ps Status</label>
													<div class="col-sm-7">
														<select class="form-control" name="fourps" required>
															<option value="Yes" <?php if ($fourps == 'Yes') { echo 'selected'; } ?>>Yes</option>
															<option value="No" <?php if ($fourps == 'No') { echo 'selected'; } ?>>No</option>
														</select>
													</div>
												</div>
												<div class="form-group row">
										...
										<?php
											...
											if (isset($_POST['save_pass'])) {
												$model->verifyResident($r_id_number, $r_ext, $_POST['purok'], $_POST['birth-place'], $_POST['occupation'], $_POST['lot'], $r_fname, $r_mname, $r_lname, $_POST['gender'], $_POST['civil_status'], $_POST['block'], $_POST['email'], $r_password, $_POST['contact-number'], $_POST['birth-date'], $_POST['resident-since'], $_POST['resident-status'], $_POST['fourps'], $id);
